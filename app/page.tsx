...
function Hero({ latest }: { latest: NxtPost[] }) {
...
function HeroCollage({ posts }: { posts: NxtPost[] }) {
...
function SectionSets({
  ...
  bySection: Record<string, NxtPost[]>;
}) {
  return (
...
function RoundupsList({ posts }: { posts: NxtPost[] }) {
  return (
...
function GuidesStrip({ posts }: { posts: NxtPost[] }) {
  return (
