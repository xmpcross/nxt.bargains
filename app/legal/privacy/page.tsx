  ...
  return (
    <LegalArticle pageKey="privacy" title="Website Privacy Policy" modified={MODIFIED}>
      <p>
        ...
        <a href="https://www.nxt.bargains">www.nxt.bargains</a> (<strong>Website</strong>).
      </p>
      <p>
      ...
      <p>
        ...
        <a href="mailto:privacy@nxt.bargains">privacy@nxt.bargains</a>. All complaints will be
      ...
      <p>
        ...
        <a href="mailto:privacy@nxt.bargains">privacy@nxt.bargains</a>. We may need to verify your
      ...
      <p>
        To exercise any of these rights, email{' '}
        <a href="mailto:privacy@nxt.bargains">privacy@nxt.bargains</a> or use our{' '}
      ...
      <p>
        <strong>
          <a href="mailto:privacy@nxt.bargains?subject=Do%20Not%20Sell%20or%20Share%20My%20Personal%20Information">
      ...
      <p>
        ...
        <a href="mailto:privacy@nxt.bargains">privacy@nxt.bargains</a>. We honor recognised opt-out
        ...
        <a href="mailto:privacy@nxt.bargains">privacy@nxt.bargains</a> with the subject line
        &quot;Appeal&quot;.
      </p>
      ...
      <p>
        ...
        please contact us at <a href="mailto:privacy@nxt.bargains">privacy@nxt.bargains</a> and we
      ...
      <p>
        ...
        <a href="mailto:privacy@nxt.bargains">privacy@nxt.bargains</a>.
      </p>
